        ...
        <div id="fp-nolink">
            ...
            <div class="navbar-collapse" id="js-navbar-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="btn-nav" href="#6">Контакты</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="inner-container for-desktop">
                    ...
                    <div class="floor-pick">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 2721 2343">
                            ...
                            <a href="/ka/bfloor/1">
                                <rect id="<?php if ($floor5 < 24): ?>Этаж&nbsp;5<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 24): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="2029" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/2">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;6<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1981" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/3">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;7<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1933" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/4">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;8<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1885" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/5">
                                <rect id="<?php if ($floor5 < 25): ?>Этаж&nbsp;9<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 25): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1841" width="1049" height="44.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/6">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;10<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1792" width="1049" height="49" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/7">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;11<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1745.5" width="1049" height="49" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/8">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;12<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1696.5" width="1049" height="49" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/9">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;13<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1647" width="1049" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/10">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;14<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1602" width="1049" height="44.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/11">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;15<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1551" width="1049" height="50.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/12">
                                <rect id="<?php if ($floor5 < 25): ?>Этаж&nbsp;16<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 25): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1505" width="1049" height="46.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/13">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;17<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1459" width="1049" height="46.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/14">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;18<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1408" width="1049" height="50.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/15">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;19<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1362" width="1049" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/16">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;20<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1316" width="1049" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/17">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;21<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1266" width="1049" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/18">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;22<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1216" width="1049" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/19">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;23<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1166" width="1049" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/20">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;24<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1122" width="1049" height="43.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/21">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;25<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1078" width="1049" height="43.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/22">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;26<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="1029" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/23">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;27<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="980" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/24">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;28<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="931" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/25">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;29<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="882" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/26">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;30<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="833" width="1049" height="48.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/27">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;31<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="789" width="1049" height="43.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/28">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;32<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="745" width="1049" height="43.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/29">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;33<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="694" width="1049" height="50.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/30">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;34<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="643" width="1049" height="50.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/31">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;35<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="596" width="1049" height="46.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/32">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;36<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="549" width="1049" height="46.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/33">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;37<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="502" width="1049" height="46.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/34">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;38<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="455" width="1049" height="46.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/35">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;39<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="413" width="1049" height="41.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/36">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;40<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="363" width="1049" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/37">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;41<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="316" width="1049" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/38">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;42<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="271" width="1049" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/39">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;43<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 26): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1208.5" y="223" width="1049" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/40">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;44<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 18): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1480" y="171" width="780" height="52" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/bfloor/41">
                                <rect id="<?php if ($floor5 < 26): ?>Этаж&nbsp;45<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 8): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="1890" y="120" width="370" height="52" stroke-miterlimit="10"/>
                            </a>

                            <!-- A Block -->
                            <polygon id="Скоро в продаже" class="sold-polygon"  points="1077 632 1121 836 1115.83 2125.17 1079.67 2125.17 410.67 2125 410.67 680 667.13 682.12 664.13 659.62 679.12 641.62 698.62 632 1077 632"/>
                            <!-- <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;1<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="2084.5" width="669.5" height="41" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;2<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="2043.5" width="669.5" height="41" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;3<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="2002.5" width="669.5" height="41" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;4<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1957" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;5<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1914" width="669.5" height="41.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;6<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1863" width="669.5" height="49.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;7<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1816" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;8<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1770" width="669.5" height="44.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;9<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1721" width="669.5" height="47.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;10<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1678.5" width="669.5" height="41" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;11<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1631" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;12<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1583" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;13<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1533" width="669.5" height="47.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;14<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1489.5" width="669.5" height="41" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;15<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1442" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;16<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1394" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;17<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1351" width="669.5" height="40.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;18<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1303" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;19<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1257" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;20<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1211" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;21<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1165" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;22<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1119" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;23<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1073" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;24<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="1027" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;25<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="980" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;26<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="933" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;27<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="886" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;28<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="839" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;29<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="792" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;30<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="744" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;31<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="412.5" y="698" width="669.5" height="45.5" stroke-miterlimit="10"/>
                            </a>
                            <a href="/ka/floor/10">
                                <rect id="<?php if ($floor5 < 16): ?>Этаж&nbsp;32<?php else: ?>Продано<?php endif; ?>" class="<?php if ($floor5 < 16): ?>enabled<?php else: ?>sold-polygon<?php endif; ?>" x="662" y="642" width="420" height="45.5" stroke-miterlimit="10"/>
                            </a> -->
                        </svg>
                ...
                <div class="inner-container for-mobile">
                    ...
                    <div id="blockB" class="zoom-anim-dialog mfp-hide" style="text-align:center;margin-top: -100px;">
                            ...
                            <?php  foreach ($bfloors as $floor): ?>
                                ...
                                <?php else: ?>
                                    <a href="/ru/bfloor/<?=$floor->id?>" class="floorbutton">სართული <?=$floor->floor?></a>
                                <?php endif; ?>
                            <?php endforeach; ?>
                    </div>
                    ...
                    <div id="blockA" class="zoom-anim-dialog mfp-hide" style="text-align:center;margin-top: -100px;">
                            ...
                            <?php  foreach ($floors as $floor): ?>
                                ...
                                <?php else: ?>
                                    <a href="/ru/floor/<?=$floor->id?>" class="floorbutton">სართული <?=$floor->floor?></a>
                                <?php endif; ?>
                            <?php endforeach; ?> -->
                    </div>
                </div>
                            ...
                            <div class="section-header col-sm-8 col-sm-offset-2">
                                ...
                                <div class="overflow">
                                    <div class="section-heading-outer m-b-15">
                                        <p class="sub-heading">О комплексе</p>
                                    </div>
                                </div>
                                <div class="overflow">
                                    <div class="section-heading-outer p-l-50 p-r-50">
                                        ...
                                        Элитный жилой комплекс от застройщика Calligraphy Towers</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- End: Section Heading -->
                            ...
                            <div class="each-services-outer overflow section-separator sp-bottom">
                                        ...
                                        <div class="overflow">
                                            ...
                                            <?php if ($aboutus):  ?>
                                                <?php foreach ($aboutus as $about):  ?>
                                                    <div style="color:#fff"><?=$about->content_rus?></div>
                                                <?php endforeach;?>
                                            <?php endif;  ?>
                                            </div>
                                        </div>
                                ...
                                <div class="overflow m-t-30 middle-objects" style="padding-bottom: 30px; border-bottom: 1px solid #484848;">
                                    <div class="btn-form-outer">  <!-- Button Area -->
                                        <a style="font-family: CITI-MT-Regular;" href="#towers-more-info" class="btn right-icon btn-services">Узнать больше <i class="icon icon-arrow-right"></i></a>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="text-block">
                                                        <div class="overflow">
                                                            <div class="pera-outer">
                                                                <p>
                                                                    Современная инфраструктура комплекса полностью обеспечивает покупателю доход и финансовую  стабильность. <br><br>
                                                                    Покупая квартиру в Calligraphy Towers, вы инвестируете в постоянно растущую недвижимость и, сдавая ее в аренду, получаете гарантированный стабильный доход.<br><br>
                                                                    Здание уникально своими масштабами в сочетании с 5 *  инфраструктурой , которая устанавливает высокие стандарты обслуживания, управления и строительства.<br><br>
                                                                    В архитектурном и инженерном проектировании  Calligraphy Tower   участвуют международные проектные и инженерные организации. Вентилируемый фасад здания выполняется  компанией с многолетним опытом - SPS GROUP.<br><br>
                                                                    Наше преимущество:<br>
                                                                    При покупке квартиры в Calligraphy Towers  владельцы получают 100% гарантию вида.<br><br>
                                                                    Лучшие виды сохраняются  даже спустя годы, так как,  нет перспективы построить новое здание перед комплексом.<br><br>
                                                                    Комплекс состоит из 4 блоков - 3 небоскреба : A-Tower, B-Tower, C-Tower и трехэтажной платформы D, с общей инфраструктурой.<br><br>
                                                                    В блоке А разместится  всемирно известная отельная сеть , международного бренда <br><br>
                                                                    Calligraphy towers - Это ваша возможность разумно инвестировать в недвижимость Батуми и получать доход.<br><br>
                                                                    Инфраструктура включает в себя все необходимое для активного отдыха:
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="overflow m-t-15">
                                                            <div class="list-outer">
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> Торговый центр
                                                                    </div>
                                                                </div>
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> кинотеатр ""Calligraph" 
                                                                    </div>
                                                                </div>
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> Piano & Lounge Bar с живой музыкой
                                                                    </div>
                                                                </div>
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> Co-working зона
                                                                    </div>
                                                                </div>
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> конференц-зал
                                                                    </div>
                                                                </div>
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> спа-центр
                                                                    </div>
                                                                </div>
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> тренажерный зал 
                                                                    </div>
                                                                </div>
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> бильярд 
                                                                    </div>
                                                                </div>
                                                                <div class="list col-sm-6">
                                                                    <div class="row">
                                                                        <i class="icon icon-icon-ribbon"></i> Более 300 парковочных мест 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="section-header col-sm-8 col-sm-offset-2">
                                ...
                                <div class="overflow">
                                    <div class="section-heading-outer m-b-15">
                                        <p class="sub-heading">Апартаменти</p>
                                    </div>
                                </div>
                                <div class="overflow">
                                    <div class="section-heading-outer p-l-50 p-r-50">
                                            ...
                                            <div class="title-outer">
                                                <div class="js-img-compare">
                                                    <div style="display: none;">
                                                        <span class="images-compare-label">РЕМОНТ "ПОД КЛЮЧ"</span>
                                                        <img src="/public/images/gallery/complete.jpg" alt="Before">
                                                    </div>
                                                    <div>
                                                        <span class="images-compare-label">ЧИСТОВАЯ ОТДЕЛКА</span>
                                                        <img src="/public/images/gallery/whitecarcase.jpg" alt="After">
                                                    </div>
                                                </div>

                                                <div style="display: flex; justify-content: center;">
                                                    <button class="js-front-btn remont-btn">РЕМОНТ "ПОД КЛЮЧ"</button>
                                                    <button class="js-back-btn remont-btn">ЧИСТОВАЯ ОТДЕЛКА</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="section-header col-sm-8 col-sm-offset-2">
                                ...
                                <div class="overflow">
                                    <div class="section-heading-outer m-b-15">
                                        <p class="sub-heading">МЕДИА</p>
                                    </div>
                                </div>
                                <div class="overflow">
                                    <div class="section-heading-outer p-l-50 p-r-50">
                                        <h2 class="section-heading">Calligraphy Towers Медиа</h2>
                                    </div>
                                </div>
                            </div>
                            <!-- End: Section Heading -->
                                        ...
                                        <div class="overflow">
                                            <div class="title-outer head-image">
                                                <div style="padding: 10px; text-align: center;">
                                                    <a href="/photos" class="btn" style="font-size: 16px;">ФОТО</a>
                                                </div>
                                                ...
                                                <div style="padding: 10px; text-align: center;">
                                                    <a href="/photos" class="btn btn-mask" style="font-size: 16px;">Смотреть все фото <i class="icon icon-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="overflow">
                                            <div class="title-outer head-image">
                                                <div class="back-button-outer overflow" style="padding: 10px;text-align: center;">
                                                    <a href="#media-video" class="btn right-icon btn-services btn-mask" style="font-size: 16px;">ВИДЕО</a>
                                                </div>
                                                ...
                                                <div class="back-button-outer overflow" style="padding: 10px;text-align: center;">
                                                    <a href="#media-video" class="btn right-icon btn-services btn-mask" style="font-size: 16px;">Смотреть все видео <i class="icon icon-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="section-header col-sm-8 col-sm-offset-2">
                                ...
                                <div class="overflow">
                                    <div class="section-heading-outer m-b-15">
                                        <p class="sub-heading">Часто задаваемые вопросы</p>
                                    </div>
                                </div>
                                <div class="overflow">
                                    <div class="section-heading-outer p-l-50 p-r-50">
                                        <h2 class="section-heading">FAQ. ВОПРОС — ОТВЕТ</h2>
                                    </div>
                                </div>
                            </div>
                            <!-- End: Section Heading -->
                                                ...
                                                <div class="panel-group wrap" id="bs-collapse">
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Возможно ли индивидуальное планирование?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-one" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Да, клиенты могут изменять внутреннее планирование по своему желанию
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Действует ли   внутренняя беспроцентная рассрочка?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-two" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            У нас действует внутренняя  рассрочка, которая  поможет  вам при наличии минимального начального капитала, сделать выгодную инвестицию и приобрести доходные и ликвидные апартаменты.
                                                            Внутренняя рассрочка на 36 месяцев, с 30% предоплатой.
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Облагается ли имущество налогом?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-tree" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Налог на недвижимость в Грузии не взимается.
                                                            </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Строится ли проект по новым регуляциям ?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-four" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Комплекс строится по новым регуляциям Грузии, Будет использовано энергоэффективное остекление, Огнеупорный блок, вентилируемый фасад со звукоизоляцией, С лифтами марки Mitsubishi (пожаробезопасные кабины).</br>
                                                            Строительство ведется по технологиям европейского стандарта, мы используем формовочную систему австрийского бренда Doka, что гарантирует точность строительства и в конечном итоге получение продукта высочайшего качества.</br>
                                                            Комплекс будет оборудован системой пожаротушения в соответствии с современными европейскими стандартами.</br>
                                                            Подъезд будет облицован натуральными  камнями / гранитом.</br>
                                                            Железная входная дверь будет оснащена электронным замком и одним универсальным пожароустойчивым  ключом.
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Предоставляет ли компания сервис по  управлению  апартаментов ?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-five" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            компания  предлагает  услугу управление апартаментов  через личный кабинет: оплата коммунальных услуг, отчетность по доходу, вывод заработка, источники привлечения клиентов, онлайн-синхронизатор с сайтами аренды апартаментов (Airbnb, Booking.com и более ста сайтов по всему миру). Вся эта информация по вашим апартаментам будет прозрачна для вас и доступна онлайн.
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                В каком состоянии сдаются апартаменты?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-six" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Вы  можете  выбрать апартаменты  в нескольких  кондициях  :  Черный   каркас  ,белый каркас, апартаменты с ремонтом  с мебелью  и техникой.
                                                            </div>
                                                    ...
                                                    <div class="panel">
                                                        ...
                                                        <div id="col-seven" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Белый каркас подразумевает помещение с готовой внутренней отделкой (стяжка, штукатурка), металлопластмассовыми окнами, металлическими входными дверьми, внутренними перегородками по вашему проекту </br>
                                                            приобретая белый каркас, вы экономите время и силы, которые уходят на черную работу.</br>
                                                            Черный каркас предполагает отсутствие внутренней отделки. встроены металлопластмассовые окна, входные двери, подведенные до входной двери помещения коммуникации. преимущества: более низкая цена, планировка и отделка помещения будет сделана по вашему вкусу.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end of panel -->
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Может ли гражданин другой страны приобрести квартиру в Грузии?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-8" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Для приобретения недвижимости в Грузии гражданство не имеет значения. иностранные граждане могут приобретать в собственность недвижимость жилье, в не зависимо от того, гражданином какой страны они являются.
                                                            </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Какие условия приобретения недвижимости для иностранных граждан?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-9" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Условия покупки недвижимости в Грузии не отличаются. Гражданин любой страны может приобрести недвижимость в собственность.
                                                            </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Можно ли приобрести недвижимость удаленно?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-10" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Да можно, предварительно получив договор купли продажи, перевести сумму на расчетный счет компании. После этого представители компании отправят вам, соответствующие документы и чеки в электронном в виде.
                                                            </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Какая процедура покупки квартиры в новостройке в Грузии?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-11" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Покупка квартиры в строящейся новостройке: </br>
                                                            1. заключение предварительного договора купли-продажи между продавцом — компанией-застройщиком, и покупателем.</br>
                                                            2. внесение платежа на расчётный счёт продавца соответственно договору купли-продажи.</br>
                                                            3. оформление собственности в публичном реестре. при покупке жилья в строящемся здании, оформляется два договора – предварительный и основной. предварительный договор включает в себя: -обязательство компании сдать дом в определенные сроки и в состоянии, которое описывается в том же договоре — обязательства сторон подписать в дальнейшем основной договор. с момента подписания предварительного договора и до момента подписания основного договора – покупатель регистрируется в реестре как будущий собственник строящейся квартиры. к моменту подписания основного договора обе стороны должны выполнить свои обязательства, согласно предварительному договору: компания — построить и сдать квартиру в срок и в состоянии, условленном договором, покупатель же должен выплатить полную стоимость квартиры. при подписании основного договора квартира снова регистрируется в реестре на покупателя, как на собственника.</br></br>

                                                            необходимые документы для оформления в реестре:</br>
                                                            1. копия удостоверения личности</br>
                                                            2. договор, купли-продажи.</br>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Сколько стоят услуги оформления в публичном реестре?
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="col-12" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                            Стоимость услуг и сроки оформления в публичном реестре: 4 рабочих дня— 50 лари 1 рабочий день — 150 лари оформление в день подачи заявления — 200 лари.
                                                            </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                                                ...
                                                                Сколько стоят коммунальные услуги в Грузии?
                                                                </a>
                                                            </h4>
                                                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="section-header col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="overflow">
                                        <div class="section-heading-outer m-b-15">
                                            <p class="sub-heading">Контакт с нами</p>
                                        </div>
                                    </div>
                                    <div class="overflow">
                                        <div class="section-heading-outer p-l-50 p-r-50">
                                            <h2 class="section-heading">Свяжитесь с нами для консультации</h2>
                                        </div>
                                    </div>
                                </div>
                                <!-- End: Section Heading -->
                                ...
                                <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 overflow">
                                    <div class="row single-form-outer">
                                        <h6 class="success dark-background">Ваше сообщение отправлено, мы скоро вам ответим</h6>
                                        ...
                                        <form id="contact-form" method="post" class="dark-background single-form">
                                            ...
                                            <div class="btn-form text-center col-xs-12">
                                                <div class="button-outer relative" style="text-align: right;">
                                                    <button class="btn btn-fill right-icon">Отправить <i class="icon icon-arrow-right"></i></button>
                                                </div>
                                            </div>
                                        </form>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="each-section col-sm-4 col-xs-12">
                                                    ...
                                                    <ul class="nav">
                                                        <li class="overflow">
                                                            <div class="li-inner">
                                                                <span class="btn-mask">УЛ. ДЖУЛИ ШАРТАВА Д.18, БАТУМИ, ГРУЗИЯ</span>
                                                            </div>
                                                        </li>
                                                    </ul>
